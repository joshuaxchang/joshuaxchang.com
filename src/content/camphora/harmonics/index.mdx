...
| Scenario | Five Fan Speeds (%) | Recording |
| :--- | :--- | :--- |
...
| Scenario | Offset Strategy | Generated Audio |
| :--- | :--- | :--- |
...
## Conclusions
With these tests and simulations, we can see that running just 1 fan at 1-2% slower than the rest increases the beat frequency. This higher frequency beat should be less perceptible than the slow, throbbing drone produced when all the fans are commanded to run at the same speed. Increasing the stagger or increasing the slow fan count does not improve the beat frequency issue, yet it decreases performance by spinning many of the fans slower. With my final design, I will have 1 fan PWM header controlled separately to run one fan at 2% slower than the rest.